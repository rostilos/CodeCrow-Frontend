...
class GitHubService extends ApiService {
  async getUserConnections(workspaceSlug: string): Promise<GitHubConnections> {
    return this.request<GitHubConnections>(
      `/${workspaceSlug}/vcs/github/list`,
      {},
    );
  }
  ...
  async createUserConnection(
    ...
    connectionData: GitHubConnectionCreateRequest,
  ): Promise<GitHubConnection> {
    return this.request<GitHubConnection>(
      `/${workspaceSlug}/vcs/github/create`,
      {
        method: "POST",
  ...
  async getConnection(
    ...
    return this.request<GitHubConnection>(
      `/${workspaceSlug}/vcs/github/connections/${connectionId}`,
      {},
    );
  }
  ...
  async updateConnection(
    workspaceSlug: string,
    connectionId: number,
    data: Partial<GitHubConnectionCreateRequest>,
  ): Promise<GitHubConnection> {
    return this.request<GitHubConnection>(
      `/${workspaceSlug}/vcs/github/connections/${connectionId}`,
      {
  ...
  async syncConnection(
    ...
    return this.request<GitHubConnection>(
      `/${workspaceSlug}/integrations/github/connections/${connectionId}/sync`,
      {
        method: "POST",
      },
    );
  ...
  async getInstallUrl(workspaceSlug: string): Promise<{ installUrl: string }> {
    return this.request<{ installUrl: string }>(
      `/${workspaceSlug}/integrations/github/app/install-url`,
      {},
    );
  }
  ...
  async createRepositoryTokenConnection(
    ...
    return this.request<GitHubConnection>(
      `/${workspaceSlug}/vcs/github/create-repository-token`,
      {
        method: "POST",
