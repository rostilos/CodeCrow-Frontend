...
class BitbucketCloudService extends ApiService {
  ...
  ): Promise<BitbucketConnections> {
    return this.request<BitbucketConnections>(
      `/${workspaceSlug}/vcs/bitbucket_cloud/list`,
      {},
    );
  }
  ...
  async createUserConnection(
    workspaceSlug: string,
    connectionData: BitbucketConnectionCreateRequest,
  ): Promise<BitbucketConnection> {
    return this.request<BitbucketConnection>(
      `/${workspaceSlug}/vcs/bitbucket_cloud/create`,
      {
        method: "POST",
  ...
  async getConnection(
    ...
    return this.request<BitbucketConnection>(
      `/${workspaceSlug}/vcs/bitbucket_cloud/connections/${connectionId}`,
      {},
    );
  }
  ...
  async updateConnection(
    workspaceSlug: string,
    connectionId: number,
    data: Partial<BitbucketConnectionCreateRequest>,
  ): Promise<BitbucketConnection> {
    return this.request<BitbucketConnection>(
      `/${workspaceSlug}/vcs/bitbucket_cloud/connections/${connectionId}`,
      {
   ...
   * Repository Access Tokens provide access to a single repository only.
   */
  async createRepositoryTokenConnection(
    ...
    return this.request<BitbucketConnection>(
      `/${workspaceSlug}/vcs/bitbucket_cloud/create-repository-token`,
      {
        method: "POST",
