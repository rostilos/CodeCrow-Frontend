...
export const DASHBOARD_ROUTES = {
  ...
  PROJECT_NEW: (workspaceSlug: string) =>
    `/dashboard/${workspaceSlug}/projects/import`,
  PROJECT_IMPORT: (
    ...
    if (params) {
      ...
      if (params.connectionId)
        searchParams.set("connectionId", String(params.connectionId));
      if (params.provider) searchParams.set("provider", params.provider);
      if (params.connectionType)
        searchParams.set("connectionType", params.connectionType);
  ...
  ANALYSIS_SOURCE_VIEW: (
    ...
    const base = `/dashboard/${workspaceSlug}/projects/${namespace}/analysis/${analysisId}/source`;
    if (params) {
      const searchParams = new URLSearchParams(params);
      const queryString = searchParams.toString();
      return queryString ? `${base}?${queryString}` : base;
  ...
  BRANCH_SOURCE_VIEW: (
    ...
    const base = `/dashboard/${workspaceSlug}/projects/${namespace}/branches/${encodeURIComponent(branchName)}/source`;
    if (params) {
      const searchParams = new URLSearchParams(params);
      const queryString = searchParams.toString();
      return queryString ? `${base}?${queryString}` : base;
  ...
  HOSTING_SETTINGS: (workspaceSlug: string) =>
    `/dashboard/${workspaceSlug}/hosting`,
  HOSTING_ADD_CONNECTION: (workspaceSlug: string) =>
    `/dashboard/${workspaceSlug}/hosting/add-connection`,
  HOSTING_CONFIGURE: (workspaceSlug: string, connectionId: string | number) =>
    `/dashboard/${workspaceSlug}/hosting/configure/${connectionId}`,
  HOSTING_GITHUB_ADD: (workspaceSlug: string) =>
    `/dashboard/${workspaceSlug}/hosting/github/add-connection`,
  HOSTING_GITHUB_CONFIGURE: (
    workspaceSlug: string,
    connectionId: string | number,
  ) => `/dashboard/${workspaceSlug}/hosting/github/configure/${connectionId}`,
  HOSTING_GITHUB_CALLBACK: (workspaceSlug: string) =>
    `/dashboard/${workspaceSlug}/hosting/github/callback`,
  HOSTING_GITLAB_ADD: (workspaceSlug: string) =>
    `/dashboard/${workspaceSlug}/hosting/gitlab/add-connection`,
  HOSTING_GITLAB_CONFIGURE: (
    workspaceSlug: string,
    connectionId: string | number,
  ...
  WORKSPACE_SETTINGS: (workspaceSlug: string) =>
    `/dashboard/${workspaceSlug}/workspace`,
  TASK_SETTINGS: (workspaceSlug: string) => `/dashboard/${workspaceSlug}/tasks`,
  QUALITY_GATES: (workspaceSlug: string) =>
    `/dashboard/${workspaceSlug}/quality-gates`,
  BILLING_SETTINGS: (workspaceSlug: string) =>
...
export function createWorkspaceRoutes(workspaceSlug: string) {
  return {
    ...
    projectDetail: (namespace: string) =>
      DASHBOARD_ROUTES.PROJECT_DETAIL(workspaceSlug, namespace),
    projectSetup: (namespace: string) =>
      DASHBOARD_ROUTES.PROJECT_SETUP(workspaceSlug, namespace),
    projectSetupSuccess: (namespace: string) =>
      DASHBOARD_ROUTES.PROJECT_SETUP_SUCCESS(workspaceSlug, namespace),
    projectSettings: (namespace: string, tab?: string) =>
      DASHBOARD_ROUTES.PROJECT_SETTINGS(workspaceSlug, namespace, tab),
    branchIssues: (
      namespace: string,
      branchName: string,
      params?: {
      ...
      DASHBOARD_ROUTES.BRANCH_ISSUES(
        workspaceSlug,
        namespace,
        branchName,
        params,
    ...
    analysisSourceView: (
      ...
      DASHBOARD_ROUTES.ANALYSIS_SOURCE_VIEW(
        workspaceSlug,
        namespace,
        analysisId,
        params,
    ...
    branchSourceView: (
      ...
      DASHBOARD_ROUTES.BRANCH_SOURCE_VIEW(
        workspaceSlug,
        namespace,
        branchName,
        params,
    ...
    projectJobs: (namespace: string) =>
      DASHBOARD_ROUTES.PROJECT_JOBS(workspaceSlug, namespace),
    projectJobDetail: (
      namespace: string,
      jobId: string | number,
      params?: Record<string, string>,
    ) =>
      DASHBOARD_ROUTES.PROJECT_JOB_DETAIL(
        workspaceSlug,
        namespace,
        jobId,
        params,
    ...
    hostingAddConnection: () =>
      DASHBOARD_ROUTES.HOSTING_ADD_CONNECTION(workspaceSlug),
    ...
    hostingGitHubCallback: () =>
      DASHBOARD_ROUTES.HOSTING_GITHUB_CALLBACK(workspaceSlug),
    ...
    hostingSuccess: (provider: string) =>
      DASHBOARD_ROUTES.HOSTING_SUCCESS(workspaceSlug, provider),
    ...
    bitbucketConnectHandshake: () =>
      DASHBOARD_ROUTES.BITBUCKET_CONNECT_HANDSHAKE(workspaceSlug),
  };
}
